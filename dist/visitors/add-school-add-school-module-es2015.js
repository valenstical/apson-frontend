...
let AddSchoolComponent = class AddSchoolComponent extends shared__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
...
let AddSchoolModule = class AddSchoolModule {
};
...
let BasicDetailsComponent = class BasicDetailsComponent extends shared__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
    constructor(formBuilder, requestService, commonService) {
        super();
    ...
    createSchool() {
        this.subscription.add(this.requestService.post('schools', this.formData.value).subscribe(response => {
            const { data } = response;
            this.toggleLoaders(false);
...
BasicDetailsComponent.ctorParameters = () => [
...
//# sourceMappingURL=add-school-add-school-module-es2015.js.map