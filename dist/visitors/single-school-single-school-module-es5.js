...
var SingleSchoolComponent = /** @class */ (function (_super) {
    ...
    SingleSchoolComponent.prototype.ngOnInit = function () {
        ...
        this.subscription.add(this.requestService.getSchool(id).subscribe(function (_a) {
            var data = _a.data;
            _this.school = data;
...
var SingleSchoolModule = /** @class */ (function () {
...
//# sourceMappingURL=single-school-single-school-module-es5.js.map